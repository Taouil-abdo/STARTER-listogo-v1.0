            ...
            if( navScrollSpy.length ){
                ...
                $('.scroll').on('click', function(event) {
                    ...
                    $(document).on('click', '.nav li', function(e) {
                        ...
                        // Check if target is an internal link (i.e., starts with #) or an external page
                        if (target.charAt(0) === '#') {
                            e.preventDefault(); // Prevent default anchor behavior for internal links
                    
                            var $sectionOffset = $(target).offset(),
                                $section = $sectionOffset ? $sectionOffset.top : 0, // Fallback to 0 if undefined
                                $window = $(window).width(),
                        ...
                        // For external links (e.g., "contact.html"), allow normal navigation
                    });
                });
